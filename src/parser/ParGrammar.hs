...
{-# INLINE happyOut68 #-}
happyIn69 :: (EAlt) -> (HappyAbsSyn )
happyIn69 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn69 #-}
happyOut69 :: (HappyAbsSyn ) -> (EAlt)
happyOut69 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut69 #-}
happyIn70 :: (ETopPattern) -> (HappyAbsSyn )
happyIn70 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn70 #-}
happyOut70 :: (HappyAbsSyn ) -> (ETopPattern)
happyOut70 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut70 #-}
happyIn71 :: (EPattern) -> (HappyAbsSyn )
happyIn71 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn71 #-}
happyOut71 :: (HappyAbsSyn ) -> (EPattern)
happyOut71 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut71 #-}
happyIn72 :: (EPatConstrArg) -> (HappyAbsSyn )
happyIn72 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn72 #-}
happyOut72 :: (HappyAbsSyn ) -> (EPatConstrArg)
happyOut72 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut72 #-}
happyIn73 :: ([EPatConstrArg]) -> (HappyAbsSyn )
happyIn73 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn73 #-}
happyOut73 :: (HappyAbsSyn ) -> ([EPatConstrArg])
happyOut73 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut73 #-}
happyIn74 :: ([EAlt]) -> (HappyAbsSyn )
happyIn74 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyIn74 #-}
happyOut74 :: (HappyAbsSyn ) -> ([EAlt])
...
happyExpList = HappyA# ""#

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_pProg","%start_pLit","%start_pExpr8","%start_pExpr7","%start_pExpr3","%start_pExpr6","%start_pExpr5","%start_pExpr4","%start_pExpr2","%start_pExpr1","%start_pExpr","%start_pListExpr","%start_pAddOp","%start_pMulOp","%start_pRelOp","%start_pDecl","%start_pFunArgIdent","%start_pListFunArgIdent","%start_pConstrDef","%start_pConstrArg","%start_pListConstrArg","%start_pListConstrDef","%start_pListDecl","%start_pTy2","%start_pTy1","%start_pTy","%start_pBind","%start_pBindElem","%start_pListBindElem","%start_pEAlt","%start_pETopPattern","%start_pEPattern","%start_pEPatConstrArg","%start_pListEPatConstrArg","%start_pListEAlt","Integer","Ident","Prog","Lit","Expr8","Expr7","Expr3","Expr6","Expr5","Expr4","Expr2","Expr1","Expr","ListExpr","AddOp","MulOp","RelOp","Decl","FunArgIdent","ListFunArgIdent","ConstrDef","ConstrArg","ListConstrArg","ListConstrDef","ListDecl","Ty2","Ty1","Ty","Bind","BindElem","ListBindElem","EAlt","ETopPattern","EPattern","EPatConstrArg","ListEPatConstrArg","ListEAlt","'!'","'!='","'&&'","'('","')'","'*'","'+'","','","'-'","'->'","'/'","':'","'::'","';'","'<'","'<='","'='","'=='","'>'","'>='","'@'","'Bool'","'Int'","'List'","'['","'\\\\'","']'","'_'","'case'","'data'","'else'","'false'","'if'","'in'","'let'","'of'","'then'","'true'","'{'","'|'","'||'","'}'","L_integ","L_ident","%eof"]
        bit_start = st * 119
        bit_end = (st + 1) * 119
...
happyActOffsets = HappyA# ""#

happyGotoOffsets :: HappyAddr
happyGotoOffsets = HappyA# ""#
...
happyCheck = HappyA# ""#

happyTable :: HappyAddr
happyTable = HappyA# ""#
...
happyReduction_111 happy_x_1
	...
	happyIn71
		 (AbsGrammar.EPatBind happy_var_1
	)}
